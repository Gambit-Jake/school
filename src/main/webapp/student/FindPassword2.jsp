        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="contact-form col-12 col-md-6  mx-auto">
                    <form id="contact-form" method="post" action="FindPassword2.jsp" role="form">

                        <div class="form-group">
                            <input type="text" placeholder="Verification code" class="form-control"
                                name="Verification_code" id="name">
                        </div>

                        <div class="form-group">
                            <input type="email" placeholder="New Password" class="form-control" name="email" id="email">
                        </div>

                        <div class="form-group">
                            <input type="email" placeholder="Confirm the password" class="form-control" name="email"
                                >
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">send successfully</h4>
                </div>
                <div class="modal-body">
                    We have sent the verification code to your email, please note that check
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn" data-dismiss="modal"
                        style="background-color: RGB(51,186,157); color: aliceblue;">Close</button>
                </div>
            </div>
        </div>
    </div>
