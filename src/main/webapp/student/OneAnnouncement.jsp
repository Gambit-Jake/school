...
<section class="page-wrapper section" style="min-height: 600px;">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>ANN_title</h2>
                <p>Department_id, Department_name</p>
            </div>
            <div class="col-md-8">
                <h4>ann_title</h4>
...
<script type="text/javascript">
    ...
    $('.page-wrapper .col-md-4 h2').html(announcement.ann_title);
    if (announcement.ann_type == 1) {
        type = 'life'
    } else {
        type = 'study'
    }
    $('.page-wrapper .col-md-4 p').html("Department id:  " + announcement.ann_id + " &nbsp;&nbsp;&nbsp; type:  " + type);
    $('.page-wrapper h4').html(announcement.ann_title);
    $('.page-wrapper .col-md-8 p').html(announcement.ann_content)
