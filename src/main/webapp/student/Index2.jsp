                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="Index2.jsp">Home <span
                                        class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Announcement.jsp">Announcement</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center mb-4 mb-lg-0">
                <div class="video-player">
                    <video id="video1" width="560" style="margin-top:0px;" controls>
                        ...
                        <source src="../files/reader function.mp4" type="video/mp4"/>
            ...
            <div class="col-lg-6">
                <div class="block">
                    ...
                    <p>XDU has over 35,000 students including over 12,000 graduates. The university consists of 18
                        schools.
                    </p>
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <a data-scroll href="./Index2.jsp" class="btn btn-main">sign In</a>
                        </li>
                    </ul>
                </div>
            </div>
