                ...
                <div class="col-md-6 mx-auto">
                    <div class="block text-center">
                        ...
                        <form class="text-left " action="Index2.jsp">
                            ...
                            <div class="form-group">
                                <input type="text" id="Gander" disabled="disabled" class="form-control" placeholder="Gander">
                            </div>
                            <div class="row">
                                <p class="col-sm-3"style="color:RGB(51,186,157);">Birthday:</p>
                            </div>
                            <div class="form-group">
                                <input type="text" id="Birthday" disabled="disabled" class="form-control" placeholder="Birthday">
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                                <input type="text" id="Native_place" disabled="disabled" class="form-control" placeholder="Native_place">
                            </div>
                            <div class="row">
                                <p class="col-sm-3" style="color:RGB(51,186,157);">Id_card_number:</p>
                            </div>
                            <div class="form-group">
                                <input type="text" id="Id_card_number" disabled="disabled" class="form-control" placeholder="Id_card_number">
                            </div>
                            <div class="row">
                                <p class="col-sm-3" style="color:RGB(51,186,157);">Department:</p>
                            </div>
                            <div class="form-group">
                                <input type="text" id="Department" disabled="disabled" class="form-control" placeholder="Department">
                            </div>
                            <button type="button" class="btn btn-main text-center" id="change">Change it</button>
                            <button type="button" class="btn btn-main "  id="submit-button" style="visibility:hidden; " data-toggle="modal" data-target="#myModal">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="confirm">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" id="confirm-btn" class="btn" style="background-color: #31BB9E; color: aliceblue;">Save changes</button>
                  </div>
            </div>
        </div>
    </div>
